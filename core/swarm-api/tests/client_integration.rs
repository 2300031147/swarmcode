...
async fn stream_message_parses_sse_events_with_tool_use() {
    ...
    let sse = concat!(
        "event: message_start\n",
        "data: {\"type\":\"message_start\",\"message\":{\"id\":\"msg_stream\",\"type\":\"message\",\"role\":\"assistant\",\"content\":[],\"model\":\"swarm-model-sonnet\",\"stop_reason\":null,\"stop_sequence\":null,\"usage\":{\"input_tokens\":8,\"output_tokens\":0}}}\n\n",
    ...
    let server = spawn_server(
        ...
        vec![
            ...
            http_response(
                "200 OK",
                "application/json",
                "{\"id\":\"msg_retry\",\"type\":\"message\",\"role\":\"assistant\",\"content\":[{\"type\":\"text\",\"text\":\"Recovered\"}],\"model\":\"swarm-model-sonnet\",\"stop_reason\":\"end_turn\",\"stop_sequence\":null,\"usage\":{\"input_tokens\":3,\"output_tokens\":2}}",
            ),
        ],
    )
    .await;
...
async fn provider_client_dispatches_api_requests() {
    ...
    let server = spawn_server(
        ...
        vec![http_response(
            "200 OK",
            "application/json",
            "{\"id\":\"msg_provider\",\"type\":\"message\",\"role\":\"assistant\",\"content\":[{\"type\":\"text\",\"text\":\"Dispatched\"}],\"model\":\"swarm-model-sonnet\",\"stop_reason\":\"end_turn\",\"stop_sequence\":null,\"usage\":{\"input_tokens\":3,\"output_tokens\":2}}",
        )],
    )
    .await;
...
#[tokio::test]
#[ignore = "requires CLAWSWARM_API_KEY and network access"]
async fn live_stream_smoke_test() {
    let client = ApiClient::from_env().expect("CLAWSWARM_API_KEY must be set");
    let mut stream = client
        .stream_message(&MessageRequest {
            model: std::env::var("CLAW_MODEL").unwrap_or_else(|_| "swarm-model-sonnet".to_string()),
            max_tokens: 32,
...
fn sample_request(stream: bool) -> MessageRequest {
    MessageRequest {
        model: "swarm-model-sonnet".to_string(),
        max_tokens: 64,
        messages: vec![InputMessage {
            ...
            content: vec![
                ...
                InputContentBlock::ToolResult {
                    ...
                    content: vec![swarm_api::ToolResultContentBlock::Json {
