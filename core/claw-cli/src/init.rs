...
const GITIGNORE_COMMENT: &str = "# ClawSwarm local artifacts";
...
pub(crate) fn render_init_claw_md(cwd: &Path) -> String {
    ...
    let mut lines = vec![
        "# CLAW.md".to_string(),
        String::new(),
        "This file provides guidance to ClawSwarm (clawcode.dev) when working with code in this repository.".to_string(),
        String::new(),
    ];
